    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'Admin'), ('traveler', 'Traveler'), ('sender', 'Sender')], db_index=True, default='traveler', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('id', 'ID'), ('passport', 'Passport'), ('driving_license', 'Driving License')], max_length=20)),
